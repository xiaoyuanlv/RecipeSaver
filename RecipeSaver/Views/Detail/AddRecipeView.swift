...
struct AddRecipeView: View {
    ...
    @State private var toUrl: String = ""
...
extension AddRecipeView {
    private func saveRecipe() {
        ...
        let recipe = Recipe(name: name, image: imageUrl, description: description, ingredients: ingredients, directions: directions, category: selectedCategory.rawValue, datePublished: datePublished, url: toUrl)
